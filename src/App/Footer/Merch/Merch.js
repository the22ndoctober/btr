...
export default function Merch(){
     ...
     return(
          ...
          <div className="cart" onClick={()=>{
               ...
               <span className="cart__amount">{cart.reduce((sum,item)=> sum+= item.amount.reduce((valSum,val)=> valSum+=val.amount, 0), 0)}</span>
          ...
          <h1 className='merch__h1'>Our Merch</h1>
          <div className="merch__info">*50% від прибутку піде на ЗСУ</div>
